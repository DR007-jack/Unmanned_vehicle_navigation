...
if("TRUE" STREQUAL "TRUE")
  set(point_lio_unilidar_SOURCE_PREFIX /home/amov/Desktop/Unmanned_vehicle_navigation/Unmanned_vehicle_navigation/point_lio_l2/src/point_lio_unilidar-main)
  set(point_lio_unilidar_DEVEL_PREFIX /home/amov/Desktop/Unmanned_vehicle_navigation/Unmanned_vehicle_navigation/point_lio_l2/devel)
  ...
  set(point_lio_unilidar_INSTALL_PREFIX /home/amov/Desktop/Unmanned_vehicle_navigation/Unmanned_vehicle_navigation/point_lio_l2/install)
...
if(NOT "/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'point_lio_unilidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amov/Desktop/Unmanned_vehicle_navigation/Unmanned_vehicle_navigation/point_lio_l2/src/point_lio_unilidar-main/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/amov/Desktop/Unmanned_vehicle_navigation/Unmanned_vehicle_navigation/point_lio_l2/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND point_lio_unilidar_EXPORTED_TARGETS ${${point_lio_unilidar_dep}_EXPORTED_TARGETS})
endforeach()
